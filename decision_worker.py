...
from database import fetch_pending_decisions, mark_decision_processing, mark_decision_processed
        ...
        for decision in decisions:
            ...
            for agent in selected_agents:
                ...
                if agent not in AGENT_MAP:
                    print(f"[decision_poller] unknown agent {agent} for decision {decision_id}")
                    continue
